...
* Reduced part count and overall complexity.

* Opportunity for increased scrubber efficiency. This is due to the CO2 scrubber being mounted within the large single counter-lung providing improved thermal insulation via the breathing gas when compared to non-counter lung interior mounted scrubber designs.

* Opportunity for decreased WOB when compared to other pendulum style axial flow scrubber designs due to lower average interstitial velocities within the scrubber (Not a given, highly dependent on individual design).
